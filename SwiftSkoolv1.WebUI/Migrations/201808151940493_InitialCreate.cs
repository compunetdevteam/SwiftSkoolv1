namespace SwiftSkoolv1.WebUI.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        SkillScore = c.String(maxLength: 135),
                        TeacherComment = c.String(maxLength: 700),
                ...
                c => new
                    {
                        ...
                        Name = c.String(maxLength: 205),
                        Alias = c.String(maxLength: 105),
                        Motto = c.String(maxLength: 135),
                        SchoolWebsite = c.String(maxLength: 135),
                        Country = c.String(maxLength: 135),
                        IsActive = c.Boolean(nullable: false),
                        Email = c.String(maxLength: 135),
                        Color = c.String(maxLength: 25),
                        OwernshipType = c.String(maxLength: 135),
                        DateOfEstablishment = c.DateTime(),
                        Address = c.String(maxLength: 175),
                        LocalGovtArea = c.String(maxLength: 75),
                        State = c.String(maxLength: 45),
                        SubscriptionDate = c.DateTime(),
                        SubscriptionEndDate = c.DateTime(nullable: false),
                        IsTrialAccount = c.Boolean(nullable: false),
            ...
            CreateTable(
                "dbo.ParentEmailAddresses",
                c => new
                    {
                        ParentEmailAddressId = c.Int(nullable: false, identity: true),
                        StudentId = c.String(),
                        EmailAddress = c.String(),
                        IsActive = c.Boolean(nullable: false),
                        SchoolId = c.String(maxLength: 8000, unicode: false),
                    })
                .PrimaryKey(t => t.ParentEmailAddressId)
                .Index(t => t.SchoolId);
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.ParentEmailAddresses");
